...
class NotificationService {
  ...
  static const int _statusSecureId = 100;
  ...
  Future<void> scheduleCheckInReminders(
    ...
    await _plugin.cancel(_statusSecureId);
    ...
    await _scheduleIfBeforeExpiry(
      id: _statusSecureId,
      title: 'Status: Secure',
      body: 'You are protected. Keep your signal strong.',
      scheduledFor: base.add(const Duration(days: 10)),
      expiry: expiry,
    );
    ...
    await _scheduleIfBeforeExpiry(
      ...
      scheduledFor: base.add(const Duration(days: 20)),
      expiry: expiry,
    );
    ...
    await _scheduleIfBeforeExpiry(
      ...
      scheduledFor: base.add(const Duration(days: 27)),
      expiry: expiry,
    );
  }
