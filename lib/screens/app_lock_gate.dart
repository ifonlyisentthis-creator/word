...
class _AppLockGateState extends State<AppLockGate>
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    if (state == AppLifecycleState.resumed) {
      ...
      if (_wasPaused && _isUnlocked && !_isAuthenticating) {
  ...
  Future<void> _authenticateIfNeeded() async {
    ...
    // Delay to let the Flutter engine finish its first frame.
        ...
        switch (exception.code) {
          ...
          case 'PasscodeNotSet':
            ...
            _errorMessage =
                ...
                'Set up a screen lock or biometrics in your phone settings, then try again.';
