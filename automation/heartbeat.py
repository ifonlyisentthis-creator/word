...
def wrap_email_html(
    ...
    *,
    ...
    conversational_footer = (
        ...
        'This is an automated security directive generated by Afterword\'s '
        'zero-knowledge protocol. Replies to this address are unmonitored.</p>'
    )
    return (
        '<!DOCTYPE html>'
        '<html lang="en">'
...
def build_unlock_email_payload(
    ...
    body_html = (
        ...
        '<p style="margin:0 0 20px;font-size:12px;color:#555;'
        'background:#f8f8f8;border-radius:6px;padding:12px 14px;'
        'border-left:3px solid #ccc">'
        'To ensure uninterrupted delivery of any future secure payloads from '
