...
def wrap_email_html(
    ...
    *,
    ...
    conversational_footer = (
        ...
        'This is an automated security directive generated by Afterword\'s zero-knowledge protocol. '
        'Replies to this address are unmonitored.</p>'
    )
    return (
        '<!DOCTYPE html>'
        '<html lang="en">'
        ...
        'Afterword &middot; afterword-app.com'
        '</div>'
        '</div>'
        '</body></html>'
    )
...
def build_unlock_email_payload(
    ...
    text = (
        f"Hi, {sender_name} assigned you as a trusted beneficiary. "
        "Because their check-in timer expired, the following encrypted payload "
        "has been automatically released to you. This is an automated cryptographic release. "
        "Afterword will never ask you to reply to this email, and we will never ask you to provide your security key.\n\n"
        f"Title: {entry_title}\n\n"
        ...
        "To ensure uninterrupted delivery of any future secure payloads from this sender, "
        "please add this email address to your trusted contacts.\n\n"
    ...
    body_html = (
        ...
        'encrypted payload has been automatically released to you. This is an automated '
        'cryptographic release. Afterword will never ask you to reply to this email, '
        'and we will never ask you to provide your security key.</p>'
        ...
        'To ensure uninterrupted delivery of any future secure payloads from this sender, '
        'please add this email address to your trusted contacts.</p>'
